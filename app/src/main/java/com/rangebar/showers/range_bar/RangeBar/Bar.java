...
package com.rangebar.showers.range_bar.RangeBar;
...
class Bar {
    ...
    private void drawTicks(Canvas canvas) {
        ...
        for (int i = 0; i < mNumSegments; i++) {
            ...
            canvas.drawText(bottomText[i],x,mTickEndY + radius + 30,mPaint);
            /*******************************/
        }
        ...
        canvas.drawText(bottomText[5],mRightX,mTickEndY + radius + 30,mPaint);
        /*******************************/
    }
}
